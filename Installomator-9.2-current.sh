            ...
            if pgrep -xq "$x"; then
                ...
                case $BLOCKING_PROCESS_ACTION in
                    ...
                    prompt_user|prompt_user_then_kill)
                      button=$(displaydialog "Quit &#x201C;$x&#x201D; to continue updating? (Leave this dialogue if you want to activate this update later) Alternatively you can also launch the update in the Self Service App." "The application &#x201C;$x&#x201D; needs to be updated.")
